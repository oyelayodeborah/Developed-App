...
{
    public class AdminRestaurantRestrictLogic : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            var MySession = HttpContext.Current.Session;
            var sessionToString = (string)MySession["role"];
            if (sessionToString==null || sessionToString==""||sessionToString!="Restaurant"|| sessionToString != "Administrator")
            {
